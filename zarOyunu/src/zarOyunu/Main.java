...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.println( oyuncu1İsim +" ortaya koydugu para");
		double bahis1 = okur.nextDouble();
		
		System.out.println( oyuncu2İsim+" ortaya koydugu para");
		...
		if (kazanan == null) {
			...
			System.out.println(oyuncu1İsim+" bakiyesi= ");
			System.out.println(o1.getBakiye());
			System.out.println(oyuncu2İsim+" bakiyesi= ");
			System.out.println(o2.getBakiye());
		}
